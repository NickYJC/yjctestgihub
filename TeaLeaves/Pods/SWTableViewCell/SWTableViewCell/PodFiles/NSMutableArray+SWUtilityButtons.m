...
- (void)sw_addUtilityButtonWithSeleselected:(BOOL)isBool Color:(UIColor *)color title:(NSString *)title font:(CGFloat)size
{
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    button.backgroundColor = color;
    button.titleLabel.font = [UIFont systemFontOfSize:size];
    button.userInteractionEnabled = isBool;
    [button setTitle:title forState:UIControlStateNormal];
    [button setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [button.titleLabel setAdjustsFontSizeToFitWidth:YES];
    [self addObject:button];
...
- (void)sw_addUtilityButtonWithColor:(UIColor *)color title:(NSString *)title font:(CGFloat)size
{
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    button.backgroundColor = color;
    button.titleLabel.font = [UIFont systemFontOfSize:size];

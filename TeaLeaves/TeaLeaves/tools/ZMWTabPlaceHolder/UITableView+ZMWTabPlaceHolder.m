//
//  UITableView+ZMWTabPlaceHolder.m
//  TeaLeaves
//
...
#import "UITableView+ZMWTabPlaceHolder.h"
#import "ZMWTabPlaceHolderDelegate.h"
...
@implementation UITableView (ZMWTabPlaceHolder)
...
- (void)walter_reloadData {
    [self reloadData];
    [self walter_checkEmpty];
}

- (void)walter_checkEmpty {
    BOOL isEmpty = YES;

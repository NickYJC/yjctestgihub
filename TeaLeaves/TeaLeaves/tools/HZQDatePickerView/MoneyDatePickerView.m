...
#import "MoneyDatePickerView.h"
#import "UIColor+HexString.h"

@interface MoneyDatePickerView ()
...
@implementation MoneyDatePickerView

+ (MoneyDatePickerView *)instanceDatePickerView
{
    NSArray* nibView =  [[NSBundle mainBundle] loadNibNamed:@"MoneyDatePickerView" owner:nil options:nil];

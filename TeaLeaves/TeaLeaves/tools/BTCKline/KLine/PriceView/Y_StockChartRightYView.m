...
{
    if (!_moveValueLabel) {
        _moveValueLabel = [self private_createLabel];
        
        _moveValueLabel.textColor = [UIColor whiteColor];
        [self addSubview:_moveValueLabel];
        [_moveValueLabel mas_makeConstraints:^(MASConstraintMaker *make) {

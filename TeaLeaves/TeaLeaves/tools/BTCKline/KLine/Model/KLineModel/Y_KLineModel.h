...
@property (nonatomic, copy) NSMutableArray *RSI_6_Array;
...
@property (nonatomic, copy) NSNumber *RSV_RSI6_UpSum;
@property (nonatomic, copy) NSNumber *RSV_RSI6_DownSum;
@property (nonatomic, copy) NSNumber *RSV_RSI12_UpSum;
@property (nonatomic, copy) NSNumber *RSV_RSI12_DownSum;
@property (nonatomic, copy) NSNumber *RSV_RSI24_UpSum;
@property (nonatomic, copy) NSNumber *RSV_RSI24_DownSum;

@property (nonatomic, copy) NSNumber *RSV_WR_10_HIGH;
@property (nonatomic, copy) NSNumber *RSV_WR_10_LOW;
@property (nonatomic, copy) NSNumber *RSV_WR_6_HIGH;
@property (nonatomic, copy) NSNumber *RSV_WR_6_LOW;
...
@property (nonatomic, copy) NSNumber *WR_10;
@property (nonatomic, copy) NSNumber *WR_6;

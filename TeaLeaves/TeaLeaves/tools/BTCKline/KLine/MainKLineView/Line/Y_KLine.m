...
//    if ([ [AppDefault shareDefault].reciprocalMaxModel.Date isEqualToString:self.kLineModel.Date]) {
//
//         NSString *High =[NSString stringWithFormat:@"%f",[self.kLineModel.High floatValue]] ;
//         CGPoint drawHighPoint = CGPointMake(self.kLinePositionModel.HighPoint.x + 1, self.kLinePositionModel.HighPoint.y - 1.5);
//        [High drawAtPoint:drawHighPoint withAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:11],NSForegroundColorAttributeName : [UIColor assistTextColor]}];
//
//    }
//    if ([ [AppDefault shareDefault].reciprocalMinModel.Date isEqualToString:self.kLineModel.Date]) {
//        NSString *Low =[NSString stringWithFormat:@"%f",[self.kLineModel.Low floatValue]] ;
//        CGPoint drawLowPoint = CGPointMake(self.kLinePositionModel.HighPoint.x + 1, self.kLinePositionModel.LowPoint.y + 1.5);
//        [Low drawAtPoint:drawLowPoint withAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:11],NSForegroundColorAttributeName : [UIColor assistTextColor]}];
//    }

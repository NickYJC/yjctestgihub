...
//  yjctest01
//
//  Created by YangJingcai on 2018/3/30.
//  Copyright © 2018年 YangJingcai. All rights reserved.
//
...
@interface LeverageViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)createRightUI
{
    ...
    topRightView.backgroundColor =[UIColor darkGrayColor];
...
- (void)viewDidLoad {
    ...
    //这里没有数据，制造一些假数据
    for (int  i = 0; i <20; i++) {
        NSString * str = [NSString stringWithFormat:@"杠杆交易 这是第%d行", i];
...
-(void)createRightTableView
{
    ...
    _rightTableView.backgroundColor =[UIColor darkGrayColor];
